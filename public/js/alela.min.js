...
function message(str){
    var mess = '<div class="alert alert-success alert-dismissable"><a href="#" class="close" data-dismiss="alert" aria-label="close">×</a>'+str+'</div>';
    $(".messages-container").append(mess);
}